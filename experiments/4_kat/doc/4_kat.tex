...
Catalase is one such enzyme which catalyses the decay of \ce{H2O2} to \ce{H2O}
and \ce{O2}. This prevents the buildup of toxic \ce{H2O2} in cells. \ce{H2O2}
accumulates over time due to the reduction of \ce{O2-} radicals.
...
implies that inhibition is competitive\cite{wiki:lburk}, with hydroxylaminase and \ce{H2O2}
